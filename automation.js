...
async function runAutomation(formData) {
  let browser;
  let monthlyIncomeNet = null; // <-- Declare at top
  let extractedValues = {
    plan1: null,
    plan2: null,
    plan3: null,
    ...
    success: false,
    formData: formData,
    message: 'Start of Plan values not found'
  };
  ...
  try {
    ...
    try {
      ...
      monthlyIncomeNet = await page.evaluate(() => {
    ...
    try {
       ...
       startOfPlanValues = await page.evaluate(() => {
      ...
      if (startOfPlanValues) {
        ...
        extractedValues = {
        plan1: startOfPlanValues.value1,
        plan2: startOfPlanValues.value2,
        plan3: startOfPlanValues.value3,
